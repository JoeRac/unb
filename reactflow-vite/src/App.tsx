...
const initialNodes: Node[] = [
  ...
  { id: 'framework', type: 'method', hidden: false, position: { x: 600, y: 100 }, data: { label: 'Somatic Intelligence Model', color: '#16213e', category: 'Core Theory' } },
  { id: 'bs-signal', type: 'method', hidden: false, position: { x: 400, y: 200 }, data: { label: 'BS (Burden Signal)', color: '#e74c3c', category: 'Signal Type', wikiUrl: 'https://example.com/bs' } },
  { id: 'us-signal', type: 'method', hidden: false, position: { x: 800, y: 200 }, data: { label: 'US (Unburden Signal)', color: '#27ae60', category: 'Signal Type' } },
  { id: 'si-grid', type: 'method', hidden: false, position: { x: 600, y: 300 }, data: { label: 'Somatic Intelligence Grid', color: '#8e44ad', category: 'Assessment' } },
  { id: 'phantom-threat', type: 'method', hidden: false, position: { x: 350, y: 400 }, data: { label: 'Phantom Threat', color: '#e67e22', category: 'Quadrant' } },
  { id: 'clear-threat', type: 'method', hidden: false, position: { x: 550, y: 400 }, data: { label: 'Clear Threat', color: '#c0392b', category: 'Quadrant' } },
  { id: 'assumed-safety', type: 'method', hidden: false, position: { x: 750, y: 400 }, data: { label: 'Assumed Safety', color: '#f39c12', category: 'Quadrant' } },
  { id: 'grounded-safety', type: 'method', hidden: false, position: { x: 950, y: 400 }, data: { label: 'Grounded Safety', color: '#27ae60', category: 'Quadrant' } },
  { id: 'step1', type: 'method', hidden: false, position: { x: 150, y: 550 }, data: { label: 'STEP 1: Immerse', color: '#3498db', category: 'Process', wikiUrl: 'https://example.com/step1' } },
  { id: 'step2', type: 'method', hidden: false, position: { x: 450, y: 550 }, data: { label: 'STEP 2: Read Signal', color: '#9b59b6', category: 'Process' } },
  { id: 'step3', type: 'method', hidden: false, position: { x: 750, y: 550 }, data: { label: 'STEP 3: Design Key', color: '#e67e22', category: 'Process' } },
  { id: 'step4', type: 'method', hidden: false, position: { x: 1050, y: 550 }, data: { label: 'STEP 4: Implement', color: '#27ae60', category: 'Process' } },
  { id: 'step1-thought', type: 'method', hidden: false, position: { x: 0, y: 650 }, data: { label: 'Thought', color: '#5dade2', category: 'Experience Type' } },
  { id: 'step1-situation', type: 'method', hidden: false, position: { x: 180, y: 650 }, data: { label: 'Real Situation', color: '#5dade2', category: 'Experience Type' } },
  { id: 'step1-sensation', type: 'method', hidden: false, position: { x: 0, y: 750 }, data: { label: 'Sensation', color: '#5dade2', category: 'Experience Type' } },
  { id: 'step1-memory', type: 'method', hidden: false, position: { x: 180, y: 750 }, data: { label: 'Memory', color: '#5dade2', category: 'Experience Type' } },
  { id: 'step2-journal', type: 'method', hidden: false, position: { x: 360, y: 650 }, data: { label: 'Journal', color: '#af7ac5', category: 'Reading Method' } },
  { id: 'step2-walk', type: 'method', hidden: false, position: { x: 540, y: 650 }, data: { label: 'Go for Walk', color: '#af7ac5', category: 'Reading Method' } },
  { id: 'step2-therapy', type: 'method', hidden: false, position: { x: 360, y: 750 }, data: { label: 'Talk Therapy', color: '#af7ac5', category: 'Reading Method' } },
  { id: 'somatic-lock', type: 'method', hidden: false, position: { x: 450, y: 850 }, data: { label: 'Somatic Lock', color: '#e74c3c', category: 'Discovery' } },
  { id: 'step3-mental', type: 'method', hidden: false, position: { x: 700, y: 650 }, data: { label: 'Pure Mental Key', color: '#f39c12', category: 'Key Type' } },
  { id: 'step3-experimental', type: 'method', hidden: false, position: { x: 900, y: 650 }, data: { label: 'Pure Experimental', color: '#f39c12', category: 'Key Type' } },
  { id: 'step3-mixed', type: 'method', hidden: false, position: { x: 800, y: 750 }, data: { label: 'Mixed Key', color: '#f39c12', category: 'Key Type' } },
  { id: 'step4-thought', type: 'method', hidden: false, position: { x: 1000, y: 650 }, data: { label: 'Repeated Thought', color: '#52be80', category: 'Implementation' } },
  { id: 'step4-action', type: 'method', hidden: false, position: { x: 1180, y: 650 }, data: { label: 'Real-World Action', color: '#52be80', category: 'Implementation' } },
  { id: 'result-instant', type: 'method', hidden: false, position: { x: 1050, y: 850 }, data: { label: 'Instant Relief', color: '#1abc9c', category: 'Result' } },
  { id: 'result-unburdened', type: 'method', hidden: false, position: { x: 1050, y: 950 }, data: { label: 'Living Unburdened', color: '#0e6655', category: 'Outcome' } },
];
